document.addEventListener('DOMContentLoaded', function () {
  ...
  setupCopy('copyCssBtn', '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/DavinIntern/assets-library-website@1.1.0/dist/alfa-icons.css">');
  setupCopy('copyJsBtn', '<script src="https://cdn.jsdelivr.net/gh/DavinIntern/assets-library-website@1.2.0/dist/assets.js"><\/script>');
});
